...
public class DocHomePageController implements Initializable {
    ...
    public TextField PFNameDoc, PLNameDoc, PMNameDoc, DOBSecDoc, PhoneSecDoc, EmailSecDoc, PharmSecDoc, InsurSecDoc,
            ChatTextFieldDoc, VisitTextFieldDoc;
    public TextArea ChatBoardDoc;
    public Label mainLabelDoc, healthLabelDoc, MedLabelDoc, ImmLabelDoc, PrescLabelDoc, VisitDoc;
    ...
    public void handleVisitMessage(ActionEvent event) throws IOException{
        String fileName = Email + ".txt";
        try {
            String message = VisitTextFieldDoc.getText();
